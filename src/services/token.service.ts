 ...
 */
const generateAuthTokens = async (user: { userId: number }): Promise<AuthTokensResponse> => {
...
const generateResetPasswordToken = async (email: string): Promise<string> => {
  ...
  await saveToken(resetPasswordToken, user.userId as number, expires, TokenType.RESET_PASSWORD);
 ...
 * @returns {Promise<string>}
 */
const generateVerifyEmailToken = async (user: { userId: number }): Promise<string> => {
